...
classdef  PASettings < handle
    ...
    properties
        ...
        %> contain settings  <b><i> {'VIEW', 'BATCH_PROCESS', 'PSD','MUSIC'}</b></i>
        fieldNames;
    ...
    methods
        ...
        function initialize(obj)
            %initialize global variables in Padaco....
        ...
        function setDefaults(obj,fieldNames)
            ...
            for f = 1:numel(fieldNames)
                switch fieldNames{f}
                    case 'VIEW'
                        obj.VIEW.accelPathname = '.'; %directory of accelerometer data.
                        obj.VIEW.accelFilename = ''; %last accelerometer data opened.
